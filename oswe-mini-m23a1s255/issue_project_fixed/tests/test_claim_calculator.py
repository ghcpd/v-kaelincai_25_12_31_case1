"""
Unit tests for ClaimCalculator (copied from original)
"""
import pytest
...
class TestClaimCalculator:
    ...
    def test_grace_period_with_zero_days_should_fail(self):
        """
        This test validates the previously failing edge case — it should now
        return a valid payout (no exception).
        """
        policy = Policy(
            policy_id="P003",
            policy_type="home",
