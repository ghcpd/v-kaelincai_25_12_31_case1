...
def demo_grace_period_zero_days_fixed():
    """Demonstrate grace period with 0 days - now works with maximum penalty"""
    print("=" * 60)
    ...
    policy = Policy(
        ...
        grace_period_days=0  # Maximum penalty applied
    )
    ...
    try:
        ...
        print(f"  Maximum penalty factor (3.0) applied for expired grace period")
        print()
    except Exception as e:
        print(f"✗ Error: {e}")
        print()
...
def demo_integration_test():
    """Demonstrate the fix in full integration scenario"""
    print("=" * 60)
    ...
    # Add policy with 0 grace period days
    policy = Policy(
        policy_id="POL_999",
        policy_type="home",
        status="grace_period",
...
if __name__ == "__main__":
    ...
    print("✓ Demo 3: Grace period with 0 days now works with maximum penalty")
    print("✓ Demo 4: Full API simulation works without crashes")
    print()
    print("The bug has been fixed! See FIX_SUMMARY.md for details")
    print("=" * 60)