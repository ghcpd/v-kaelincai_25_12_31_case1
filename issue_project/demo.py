"""
Demonstration script showing the bug in action
Run this to see the ZeroDivisionError crash
"""
...
def demo_grace_period_zero_days_bug():
    """Demonstrate the bug: grace period with 0 days crashes"""
    print("=" * 60)
    print("DEMO 3: Grace Period with 0 Days (BUG!)")
    print("=" * 60)
    ...
    policy = Policy(
        ...
        grace_period_days=0  # BUG TRIGGER!
    )
    ...
    print(f"  Grace Period Days: {policy.grace_period_days} ⚠ ZERO!")
    print(f"  Claim Amount: ${claim.claim_amount}")
    print()
    ...
    try:
        ...
        print(f"✗ CRASH! ZeroDivisionError occurred!")
        print(f"  This is the bug - division by zero in grace period calculation")
        print(f"  In production, this would return HTTP 500 Internal Server Error")
...
def demo_integration_test():
    """Demonstrate the bug in full integration scenario"""
    print("=" * 60)
    ...
    try:
        ...
        print(f"  The API crashed!")
        print(f"  User sees: 'An unexpected error occurred'")
        print(f"  Support team called, manual intervention required")
        print()
...
if __name__ == "__main__":
    print("\n")
    print("╔" + "=" * 58 + "╗")
    print("║  Insurance Claim Processing - Bug Demonstration          ║")
    print("╚" + "=" * 58 + "╝")
    print()
    ...
    demo_grace_period_zero_days_bug()
    ...
    print("✗ Demo 3: Grace period with 0 days causes ZeroDivisionError")
    print("✗ Demo 4: Full API simulation crashes with HTTP 500")
    print()
    print("See KNOWN_ISSUE.md for detailed analysis and fix suggestions")
    print("=" * 60)
